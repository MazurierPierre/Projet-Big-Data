...
data = pd.read_csv("C:\\Users\\emili\\Desktop\\project\\tests\\analyse\\operations.csv",parse_dates=[1,2])
data.columns = ['identifiant_transaction', 'date_operation', 'date_valeur', 'libelle', 'debit', 'credit', 'solde']

print(data)


# Compter les occurences de mots
...
data.to_csv("C:\\Users\\emili\\Desktop\\project\\tests\\analyse\\operations.csv", index=False)